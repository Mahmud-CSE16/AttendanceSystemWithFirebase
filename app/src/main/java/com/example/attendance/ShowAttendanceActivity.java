...
public class ShowAttendanceActivity extends AppCompatActivity {
    ...
    private void getStudents(){
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Attendances/"+course+"/"+section+"/"+date);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                StudentsAttendanceAdapter adapter = new StudentsAttendanceAdapter(getApplicationContext(),students,course,section,date);
