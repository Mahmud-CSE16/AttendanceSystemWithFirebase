...
public class StudentsAttendanceAdapter extends BaseAdapter {
    ...
    public StudentsAttendanceAdapter(Context context, List<Student> students, String course, String section, String date) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        View v = layoutInflater.inflate(R.layout.student_attendance_adapter_layout, viewGroup,false);
